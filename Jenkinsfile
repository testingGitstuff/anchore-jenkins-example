...
node {
  ...
  try {
    ...
    stage('Parallel') {
      ...
      Analyze: {
        writeFile file: anchorefile, text: "hcheungl3harris/testdummy_anchore" + "/" + repotag + " " + dockerfile
